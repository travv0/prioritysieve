...
class SettingsDialog(QDialog):  # pylint:disable=too-many-instance-attributes
    ...
    def _init_ui(self) -> None:
        ...
        self.ui.prioritysieve_version_label.setText(
            f"PrioritySieve version: {prioritysieve_globals.__version__}"
        )
    ...
    def closeWithCallback(  # pylint:disable=invalid-name
        ...
        self.close()
        aqt.dialogs.markClosed(prioritysieve_globals.SETTINGS_DIALOG_NAME)
        callback()
