...
# - https://mortii.github.io/prioritysieve/user_guide/usage/recalc.html#scoring-algorithm
#######################################
...
class CardScore:
    ...
    def __init__(
        self, am_config: PrioritySieveConfig, card_morph_metrics: CardMorphsMetrics
    ) -> None:
...
def _should_move_card_to_end(
    am_config: PrioritySieveConfig, card_morph_metrics: CardMorphsMetrics
) -> bool:
...
def _get_all_morphs_target_difference(
    am_config: PrioritySieveConfig, num_morphs: int
) -> int:
