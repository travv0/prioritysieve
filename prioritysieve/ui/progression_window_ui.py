# Form implementation generated from reading ui file 'prioritysieve/ui/progression_window.ui'
#
...
class Ui_ProgressionWindow(object):
    def setupUi(self, ProgressionWindow):
        ...
        self.priorityFileComboBox = QtWidgets.QComboBox(parent=self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.priorityFileComboBox.sizePolicy().hasHeightForWidth())
        self.priorityFileComboBox.setSizePolicy(sizePolicy)
        self.priorityFileComboBox.setSizeAdjustPolicy(QtWidgets.QComboBox.SizeAdjustPolicy.AdjustToContents)
        self.priorityFileComboBox.setPlaceholderText("")
        self.priorityFileComboBox.setObjectName("priorityFileComboBox")
        self.horizontalLayout_7.addWidget(self.priorityFileComboBox)
        ...
        self.entryTableWidget = QtWidgets.QTableWidget(parent=self.tab_3)
        self.entryTableWidget.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.entryTableWidget.sizePolicy().hasHeightForWidth())
        self.entryTableWidget.setSizePolicy(sizePolicy)
        self.entryTableWidget.setMinimumSize(QtCore.QSize(0, 0))
        self.entryTableWidget.setAutoFillBackground(False)
        self.entryTableWidget.setObjectName("entryTableWidget")
        self.entryTableWidget.setColumnCount(4)
        self.entryTableWidget.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        ...
        self.entryTableWidget.verticalHeader().setVisible(False)
        self.verticalLayout_2.addWidget(self.entryTableWidget)
        ...
        self.priorityFileComboBox.setCurrentIndex(-1)
    ...
    def retranslateUi(self, ProgressionWindow):
        ...
        self.groupBox.setTitle(_translate("ProgressionWindow", "Entries"))
        self.label_6.setText(_translate("ProgressionWindow", "Priority file:"))
        ...
        item.setText(_translate("ProgressionWindow", "Unique entries"))
        item = self.numericalTableWidget.horizontalHeaderItem(2)
        item.setText(_translate("ProgressionWindow", "Total Reviewed"))
        item = self.numericalTableWidget.horizontalHeaderItem(3)
        item.setText(_translate("ProgressionWindow", "Total Pending"))
        ...
        item.setText(_translate("ProgressionWindow", "% Reviewed"))
        item = self.percentTableWidget.horizontalHeaderItem(3)
        item.setText(_translate("ProgressionWindow", "% Pending"))
        ...
        item.setText(_translate("ProgressionWindow", "Text"))
        item = self.entryTableWidget.horizontalHeaderItem(2)
        item.setText(_translate("ProgressionWindow", "Reading"))
        item = self.entryTableWidget.horizontalHeaderItem(3)
        item.setText(_translate("ProgressionWindow", "Status"))
        self.qTabWidget.setTabText(self.qTabWidget.indexOf(self.tab_3), _translate("ProgressionWindow", "Entry list"))
